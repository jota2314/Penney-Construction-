...
export function WalkthroughReviewPanel({
  ...
  // Sign URLs for any files missing one (covers photos added after mount)
  useEffect(() => {
          ...
          <div className="grid grid-cols-2 gap-2">
            {files.map((file) => {
              ...
              return (
                <div
                  key={file.id}
                  className={`relative rounded-lg overflow-hidden bg-muted cursor-zoom-in ring-2 transition-all ${
                    isSelected ? "ring-primary" : "ring-transparent"
                  }`}
                  onClick={() => setPreviewUrl(signedUrls[file.id] || null)}
                >
