...
const schema = z.object({
  ...
  fixtures: z.array(z.object({ id, type: z.string().refine(t => Object.hasOwn(FIXTURE_DEFAULTS, t), 'Unknown fixture type'), widthIn: dimension, depthIn: dimension, heightIn: dimension, x: position, z: position, yIn: position.optional(), rotationDeg: z.number().finite().optional(), options: z.record(z.string(), z.union([z.string(), z.number().finite(), z.boolean(), z.null()])).optional() }).passthrough()).max(300),
